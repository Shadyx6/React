...
function Works() {
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
    <div className="md:w-2/3 lg:w-1/2 mt-12 text-blue-600">
      ...
      <h2 className="my-8 text-2xl font-bold text-black md:text-4xl">Our Work</h2>
      <p className="text-slate-500">We have built many products and some of them are below</p>
    </div>
    <div
